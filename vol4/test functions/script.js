...
function getDragAfterElement(container, y) {
    //"..." creates an Array out of the selected elements
    const draggableElements = [...container.querySelectorAll('.draggable:not(.dragging)')]
    //child is an element of the array draggableElements
    return draggableElements.reduce((closest, child) => {
        //function getBoundingClientRect() returns a box the size of the child element; easy access to properties of child element
